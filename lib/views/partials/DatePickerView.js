...
let DatePickerView = class DatePickerView extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { id: field.id, "data-uuid": field.uuid, className: `fl-field fl-datapicker-field fl-datepicker-${mode}` },
            React.createElement(DatePicker, { mode: component.mode, defaultValue: component.defaultValue ? moment(component.defaultValue, dateFormat) : null, format: component.dateFormat, onChange: _onChange }));
    }
};

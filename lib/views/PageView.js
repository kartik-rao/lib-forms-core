...
let PageView = class PageView extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { className: "fl-page-wrap" },
            React.createElement(Card, { style: { padding: "0" }, bordered: false },
                React.createElement("div", { id: `fl-page-${page.id || store.currentPage}`, className: "fl-page", "data-uuid": page.uuid }, page.sections.map((section, sn) => {

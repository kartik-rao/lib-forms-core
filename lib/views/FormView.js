    ...
    render() {
        ...
        return (React.createElement(Layout, { style: { height: '100%', overflow: 'hidden' }, className: "fl-form-container" },
            React.createElement("div", { className: "fl-shadow-bottom", style: { marginBottom: '2px' } },
                React.createElement(PageHeader, { className: "fl-ph", style: { 'minHeight': '68px', border: 'none' }, title: content.title, subTitle: content.subtitle, extra: (formLayoutOptions.showSteps && React.createElement("div", null,
            ...
            React.createElement(Layout, { style: { overflow: 'hidden', border: '1px solid #ededed' } },
                React.createElement(Form, Object.assign({ onSubmit: (e) => form.handleSubmit(e), layout: form.layout, style: { height: '100%' } }, formLayoutOptions),

    ...
    render() {
        ...
        return (React.createElement(Layout, { style: { height: '100vh' } },
            React.createElement("div", { className: "fl-shadow-bottom", style: { marginBottom: '2px' } },
                React.createElement(PageHeader, { style: { 'minHeight': '68px', border: 'none' }, title: content.title, subTitle: content.subtitle, extra: (form.formLayoutOptions.showSteps && React.createElement("div", null,
            ...
            React.createElement(Layout, { style: { overflow: 'hidden', border: '1px solid #ededed' } },
                React.createElement(Form, { onSubmit: (e) => form.handleSubmit(e), layout: form.layout },
                    React.createElement(Layout.Content, { style: { overflowY: 'scroll', height: 'calc(100vh - 188px)', backgroundColor: 'white' } },
                        React.createElement(PageView, { page: content.pages[formStore.currentPage], store: formStore })),
                    React.createElement(Layout.Footer, { style: { padding: '0px', position: 'fixed', bottom: 0, left: 0, width: '100%', marginTop: '1px' } },

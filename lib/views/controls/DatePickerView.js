...
export const DatePickerView = (props) => {
    ...
    return useObserver(() => {
        return React.createElement(React.Suspense, { fallback: "" },
            React.createElement(DatePicker, { mode: localStore.mode, defaultValue: localStore.defaultValue ? moment(localStore.defaultValue, localStore.dateFormat) : null, format: localStore.dateFormat, onChange: _onChange }));
    });
};

...
let ColumnView = class ColumnView extends React.Component {
    ...
    render() {
        ...
        const { fields } = column;
        return React.createElement("div", { className: "fl-col", "data-uuid": column.uuid },
            React.createElement(Col, { span: column.span ? column.span : this.props.span }, fields.map((field) => {

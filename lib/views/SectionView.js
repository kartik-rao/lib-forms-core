...
export const SectionView = (props) => {
    ...
    return useObserver(() => {
        return React.createElement("div", { className: "fl-section", "data-uuid": props.section.uuid, id: `fl-section-${props.section.id}` },
            React.createElement(Card, { bordered: fStore.form.formLayoutOptions.showSectionBorders, title: fStore.form.formLayoutOptions.showSectionTitles ? props.section.title : "", style: { padding: "1px" }, size: "small" },

...
let SectionView = class SectionView extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { className: "fl-section", "data-uuid": section.uuid, id: section.id },
            React.createElement(Card, { bordered: false, title: section.name, style: { padding: "1px" }, size: "small" },

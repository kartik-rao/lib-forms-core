...
let SectionView = class SectionView extends React.Component {
    ...
    render() {
        ...
        return React.createElement("div", { className: "fl-section", "data-uuid": section.uuid, id: `fl-section-${section.id}` },
            React.createElement(Card, { bordered: store.form.formLayoutOptions.showSectionBorders, title: store.form.formLayoutOptions.showSectionTitles ? section.title : "", style: { padding: "1px" }, size: "small" },
                React.createElement(Row, { gutter: section.gutter }, section.columns.map((column) => {

        ...
        return (
            <Layout style={{height: '100vh'}}>
                <div className="fl-shadow-bottom" style={{ marginBottom: '2px'}}>
                    <PageHeader style={{'minHeight': '68px', border: 'none'}} title={content.title} subTitle={content.subtitle}
            ...
            <Form onSubmit={(e) => form.handleSubmit(e)} layout={form.layout}>
                <Layout.Content style={{overflowY: 'scroll', height: 'calc(100vh - 188px)', backgroundColor: 'white' }}>
                    <PageView page={content.pages[formStore.currentPage] as Page} store={formStore}></PageView>
                </Layout.Content>
                <Layout.Footer style={{padding: '0px', position: 'fixed', bottom: 0, left:0, width: '100%', marginTop:'1px'}}>
